...
1. Дизайн эксперимента:
   ...
   - Модель будет оцениваться по производительности на нескольких уровнях:
     - Перевод образовательных материалов.
2. Реализация пилота:
...
3. Сравнение моделей:
   - Результаты текущей NLLB 200 сравниваются с результатами базовых моделей (mBART-50, T5).
...
2. Производительность API:
   ...
   - Устойчивость к нагрузке (минимум 1000 запросов в минуту без потери производительности).
