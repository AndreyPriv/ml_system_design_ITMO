...
- Бизнес-цель
    ...
    Целью проекта является создание доступного и эффективного инструмента для машинного перевода с русского языка на мансийский с использованием современных технологий машинного обучения.
...
- Что будем считать успехом итерации с точки зрения бизнеса `Product Owner`
  ...
  - Получение первых отзывов от реальных пользователей (например, исследовательских групп или образовательных организаций).
...
- Что считаем успешным пилотом? Критерии успеха и возможные пути развития проекта
  **•** Быстродействие: Время ответа API для перевода одной строки текста должно быть менее 1 секунды.
